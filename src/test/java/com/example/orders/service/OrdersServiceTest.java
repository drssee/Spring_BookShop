...
class OrdersServiceTest {
    ...
    public void buyBookTest() throws Exception {
        ...
        //오더의 상태는 주문완료가 되어야함
        //주문한 orderVO를 가져온다
        OrdersBookVO getOrdersBookVO = ordersDao.selectOrdersBook(ordersBookVO.getOrder_book_id());
        OrdersVO getOrdersVO = ordersDao.selectOrders(getOrdersBookVO.getOrder_id());
