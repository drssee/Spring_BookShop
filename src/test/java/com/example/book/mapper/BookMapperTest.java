...
//        assertEquals(bookVO,getBookVO);
    ...
    void selectCategory_name_idTest(){
        //임의의 bno를 초기화
        //조회는 성공해야함(0보다 커야함)
        System.out.println("!!!!!!!!! = "+bookMapper.selectCa_Books_categoryNameId(bno));
        assertTrue(bookMapper.selectCa_Books_categoryNameId(bno)>=0);
    }
    ...
    void bookCntTest(){
        ...
        assertTrue(bookMapper.bookCnt()>0);
    }
}