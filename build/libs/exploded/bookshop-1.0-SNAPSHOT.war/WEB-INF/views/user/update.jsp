                ...
                <div class="personal_info">
                    <p>
                        ...
                        <c:if test="${bindingResult==null}">
                            <input type="text" id="u_id" name="id" value="${user.id}" readonly>
                        </c:if>
                        <!--에러가 있을때-->
                        <c:if test="${bindingResult!=null}">
                            <input type="text" id="u_id" name="id" value="${bindingResult.getFieldValue("id")}" readonly>
                        </c:if>
                        <!--바인딩에러가 있을경우-->
                        <spring:hasBindErrors name="user">
                    ...
                    <p>
                        ...
                        <!--에러 없을때-->
                        <c:if test="${bindingResult==null}">
                            <input type="text" id="u_name" name="name" value="${user.name}" readonly>
                        </c:if>
                        <!--에러가 있을때-->
                        <c:if test="${bindingResult!=null}">
                            <input type="text" id="u_name" name="name" value="${bindingResult.getFieldValue("name")}" readonly>
                        </c:if>
                        <!--바인딩에러가 있을경우-->
                        <spring:hasBindErrors name="user">
                        <!--해당 필드 오류가 있을때 오류 메시지 출력-->
                    ...
                    <p class="tel_wrap">
                        ...
                        <c:if test="${bindingResult==null}">
                            <script>
                                $(document).ready(function (){
                                    let phone = '<c:out value="${user.phone}"/>';
                                    let startIndex = phone.indexOf('-');
                                    let lastIndex = phone.lastIndexOf('-');
                                    let phone1 = phone.substring(0,startIndex);
                                    $("#u_tel1").val(phone1);
                                    let phone2 = phone.substring(startIndex+1,lastIndex);
                                    $("#u_tel2").val(phone2);
                                    let phone3 = phone.substring(lastIndex+1);
                                    $("#u_tel3").val(phone3);
                                });
                            </script>
                            <input type="tel" id="u_tel1" name="phone1" value=""> -
                            <input type="tel" id="u_tel2" name="phone2" value=""> -
                            <input type="tel" id="u_tel3" name="phone3" value="">
                        </c:if>
                        <!--에러가 있을때-->
                        <c:if test="${bindingResult!=null}">
                    ...
                    <p>
                        ...
                        <!--에러 없을때-->
                        <c:if test="${bindingResult==null}">
                            <input type="email" id="email_l" name="email" value="${user.email}">
                        </c:if>
                        <!--에러가 있을때-->
                        <c:if test="${bindingResult!=null}">
